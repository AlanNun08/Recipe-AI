...
async def test_multiple_recipes():
    ...
    try:
        ...
        login_response = await client.post('https://fd9864fb-c204-41f3-8f4c-e2111c0751fc.preview.emergentagent.com/api/auth/login', json=login_data)
        user_id = login_response.json()['user']['id']
        
        # Get current plan
        plan_response = await client.get(f'https://fd9864fb-c204-41f3-8f4c-e2111c0751fc.preview.emergentagent.com/api/weekly-recipes/current/{user_id}')
        ...
        for i, meal in enumerate(meals[:3]):  # Test first 3 recipes
            ...
            # Get recipe detail
            recipe_response = await client.get(f'https://fd9864fb-c204-41f3-8f4c-e2111c0751fc.preview.emergentagent.com/api/weekly-recipes/recipe/{recipe_id}')
